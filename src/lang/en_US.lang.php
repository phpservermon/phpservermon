...
$sm_lang = array(
 ...
 servers that have been assigned to them.',
    ...
    'servers' => array(
        ...
        'website_username_description' => 'Username to access the site. (Only Apache authentication is supported.) Authentication is only verified during monitoring; check Status or Log to confirm whether login succeeds.',
        'website_password' => 'Password',
        'website_password_description' => 'Password to access the site. The password is encrypted in the database. Authentication is only verified during monitoring; check Status or Log to confirm whether login succeeds.',
