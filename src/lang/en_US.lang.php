...
$sm_lang = array(
    ...
    'diagnostic' => array(
        ...
        'send_email_subject' => 'Server Monitor diagnostic report',
        ...
        'range_hint' => 'Diagnostics are available per week, per month, and per year.',
    ),
    'users' => array(
        'user' => 'User',
        'name' => 'Name',
 ...
 servers that have been assigned to them.',
    ...
    'servers' => array(
        ...
        'website_username_description' => 'Username to access the site. These fields send HTTP authentication and can be injected into POST data via %username% / %password% placeholders for form logins. Configure a content pattern if you need login success/failure detection.',
        'website_password' => 'Password',
        'website_password_description' => 'Password to access the site. The password is encrypted in the database. Pair with POST data placeholders and a content pattern to confirm whether the login worked.',
    ...
    'config' => array(
        ...
        'log_jira' => 'Log Jira issues created by the script',
        'log_zabbix' => 'Log Zabbix alerts sent by the script',
        ...
        'settings_jira' => 'Jira settings',
        'settings_zabbix' => 'Zabbix settings',
        ...
        'jira_status' => 'Enable Jira integration',
        'jira_base_url' => 'Jira base URL',
        'jira_base_url_description' => 'Base URL to your Jira instance (e.g. https://your-domain.atlassian.net).',
        'jira_username' => 'Jira username/email',
        'jira_api_token' => 'Jira API token',
        'jira_project_key' => 'Default Jira project key',
        'zabbix_status' => 'Enable Zabbix integration',
    ...
    'notifications' => array(
        ...
        'off_email_subject' => 'Incident: Unable to connect to %LABEL% over HTTPS',
        'off_email_body' => 'Incident: Unable to connect to %LABEL% over HTTPS<br><br><strong>Details</strong><br><br>Service: %LABEL%<br>Public URL: %IP%<br>Protocol / Port: HTTPS / %PORT%<br>Error: %ERROR%<br>Date & time: %DATE%',
