...
$sm_lang = array(
	...
	'users' => array(
		...
		'pushsafer' => 'Pushsafer',
		'pushsafer_description' => 'Pushsafer je služba zasílat upozornění v reálném čase s <strong>grafu obrazu</strong> v iOS, Android a Windows 10. Viz <a href="https://www.pushsafer.com/">jejich webové stránky</a> pro více informací.',
		'pushsafer_key' => 'Pushsafer Soukromý nebo Alias Klíč',
		'pushsafer_device' => 'Pushsafer Zařízení (Skupina)',
		'pushsafer_device_description' => 'ID zařízení nebo zařízení skupiny ID poslat zprávu. Ponechte prázdné, aby jej poslat na všech zařízeních.',		
	...
	'servers' => array(
		...
		'warning_notifications_disabled_pushsafer' => 'Pushsafer upozornění jsou vypnuta.',
	...
	'config' => array(
		...
		'pushsafer_status' => 'Povolit zsílání Pushsafer zpráv',
		'pushsafer_description' => 'Pushsafer je služba zasílat upozornění v reálném čase s <strong>grafu obrazu</strong> v iOS, Android a Windows 10. Viz <a href="https://www.pushsafer.com/">jejich webové stránky</a> pro více informací.',
		'pushsafer_device' => 'Zařízení nebo zařízení ID skupiny',
		'pushsafer_icon' => 'Ikona',
		'pushsafer_sound' => 'Zvuk',
		'pushsafer_vibration' => 'Chvění',
		'pushsafer_time2live' => 'Čas se žít',
		...
		'log_pushsafer' => 'Logovat odeslané Pushsafer zprávy',
		...
		'settings_pushsafer' => 'Nastavení Pushsafer',
		...
		'test_pushsafer' => 'Pushsafer upozornění bude odesláno uživateli/zařízení dle nastavení v uživatelském profilu.',
		'send' => 'Odeslat',
		'test_subject' => 'Test',
		...
		'pushsafer_sent' => 'Pushsafer upozornění odesláno.',
		'pushsafer_error' => 'Nastala chyba při odesílání Pushsafer upozornění: %s',
		'pushsafer_error_noapp' => 'Nebylo možné odeslat testovací upozornění: ve vašem profilu není definován Pushsafer key.',
		'pushsafer_error_nokey' => 'Nebylo možné odeslat testovací upozornění: ve vašem profilu není definován Pushsafer key.',
