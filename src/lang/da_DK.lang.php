...
$sm_lang = array(
	...
	'config' => array(
		...
		'test_pushsafer' => 'En Pushsafer notifikation vil blive sendt til brugerens enhed, specificeret i brugerprofilen.',
		'send' => 'Send',
		'test_subject' => 'Test',
		...
		'pushsafer_sent' => 'Pushsafer notifikation blev sendt',
		'pushsafer_error' => 'En fejl opstod under afsendelse af Pushsafer notifikation: %s',
	...
	'notifications' => array(
		...
		'off_pushsafer_title' => 'Serveren %LABEL% er NEDE',
		'off_pushsafer_message' => "Det lykkedes ikke at oprette forbindelse til følgende server:<br/><br/>Server: %LABEL%<br/>IP: %IP%<br/>Port: %PORT%<br/>Fejl: %ERROR%<br/>Dato: %DATE%",
		...
		'on_pushsafer_title' => 'Serveren %LABEL% KØRER',
		'on_pushsafer_message' => "Serveren %LABEL% kører igen:<br/><br/>Server: %LABEL%<br/>IP: %IP%<br/>Port: %PORT%<br/>Dato: %DATE%",
	),
	'login' => array(
