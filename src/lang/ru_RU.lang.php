...
$sm_lang = array(
	...
	'notifications' => array(
		...
		'off_email_body' => "Недоступен сервер: %LABEL%<br/><br/>IP: %IP%<br/>Порт: %PORT%<br/>Ошибка: %ERROR%<br/>Дата: %DATE%",
		'off_pushover_title' => 'Cервер \'%LABEL%\' сейчас НЕДОСТУПЕН',
		'off_pushover_message' => "Недоступен сервер: %LABEL%<br/><br/>IP: %IP%<br/>Порт: %PORT%<br/>Ошибка: %ERROR%<br/>Дата: %DATE%",
		'off_telegram_message' => "*Недоступен сервер: %LABEL%*.<br/><br/>IP: %IP%<br/>Порт: %PORT%<br/>Ошибка: %ERROR%<br/>Дата: %DATE%",
