...
class ServerController extends AbstractServerController {
	...
	protected function executeEdit() {
		...
		if(!empty($edit_server)) {
			...
			$tpl_data = array_merge($tpl_data, array(
				...
				'edit_pushsafer_selected_' . $edit_server['pushsafer'] => 'selected="selected"',
			));
		}

		$notifications = array('email', 'sms', 'pushover', 'pushsafer');
	...
	protected function executeSave() {
		...
		$clean = array(
			...
			'pushsafer' => in_array($_POST['pushsafer'], array('yes', 'no')) ? $_POST['pushsafer'] : 'no',
		);
	...
	protected function getLabels() {
		return array(
			...
			'label_pushsafer' => psm_get_lang('servers', 'pushsafer'),
