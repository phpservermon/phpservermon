...
class StatusNotifier {
	...
	public function notify($server_id, $status_old, $status_new) {
		...
		$this->server = $this->db->selectRow(PSM_DB_PREFIX.'servers', array(
			...
			'server_id', 'ip', 'port', 'label', 'description', 'type', 'pattern', 'status', 'header_name', 'header_value', 'error', 'active', 'email', 'sms', 'pushover', 'telegram', 'last_online', 'last_offline', 'last_offline_duration',
		));
